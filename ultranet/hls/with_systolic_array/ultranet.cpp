...
void stream_to_mat (hls::stream<ap_uint<24> >&in,
	...
	for (int i=0; i<IN_IMAGE_HEIGHT; i++) {
        #pragma HLS loop_tripcount min=20 max=360
...
void do_compute(
    ...
    #pragma HLS STREAM variable=conv_0_out depth=16 dim=1
    hls::stream<ap_uint<CONV_0_OUT_BIT * CONV_0_OFM_CH> > pool_0_out("pool_0_out"); // 64-bit
    #pragma HLS STREAM variable=pool_0_out depth=16 dim=1
    hls::stream<ap_uint<CONV_1_OUT_BIT * CONV_1_OFM_CH> > conv_1_out("conv_1_out");
    #pragma HLS STREAM variable=conv_1_out depth=16 dim=1
    hls::stream<ap_uint<CONV_1_OUT_BIT * CONV_1_OFM_CH> > pool_1_out("pool_1_out");
    #pragma HLS STREAM variable=pool_1_out depth=16 dim=1
    hls::stream<ap_uint<CONV_2_OUT_BIT * CONV_2_OFM_CH> > conv_2_out("conv_2_out");
    #pragma HLS STREAM variable=conv_2_out depth=16 dim=1
    hls::stream<ap_uint<CONV_2_OUT_BIT * CONV_2_OFM_CH> > pool_2_out("pool_2_out");
    #pragma HLS STREAM variable=pool_2_out depth=16 dim=1
    hls::stream<ap_uint<CONV_3_OUT_BIT * CONV_3_OFM_CH> > conv_3_out("conv_3_out");
    #pragma HLS STREAM variable=conv_3_out depth=16 dim=1
    hls::stream<ap_uint<CONV_3_OUT_BIT * CONV_3_OFM_CH> > pool_3_out("pool_3_out");
    #pragma HLS STREAM variable=pool_3_out depth=16 dim=1
    hls::stream<ap_uint<CONV_4_OUT_BIT * CONV_4_OFM_CH> > conv_4_out("conv_4_out");
    #pragma HLS STREAM variable=conv_4_out depth=16 dim=1
    hls::stream<ap_uint<CONV_5_OUT_BIT * CONV_5_OFM_CH> > conv_5_out("conv_5_out");
    #pragma HLS STREAM variable=conv_5_out depth=16 dim=1
    hls::stream<ap_uint<CONV_6_OUT_BIT * CONV_6_OFM_CH> > conv_6_out("conv_6_out");
    #pragma HLS STREAM variable=conv_6_out depth=16 dim=1
    hls::stream<ap_uint<CONV_7_OUT_BIT * CONV_7_OFM_CH> > conv_7_out("conv_7_out");
    #pragma HLS STREAM variable=conv_7_out depth=16 dim=1
    ...
    conv3x3_bn_act<
        ...
        CONV_1_L_SHIFT // 8
    >(
        pool_0_out, // 64-bit stream object
        conv_1_w, // const ap_uint<64> conv_1_w[8][36] 
        conv_1_inc,
        conv_1_bias,
        conv_1_out,
        reps // int
